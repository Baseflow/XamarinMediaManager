...
namespace Plugin.MediaManager
{
    ...
    public class CrossMediaManager
    {
        ...
        {
#if NETSTANDARD2_0
            Debug.WriteLine("NETSTANDARD Reached");
            return null;
#else
        ...
        {
            return new NotImplementedException("This functionality is not implemented in the assembly.  You should reference the NuGet package from your main application project in order to reference the platform-specific implementation.");
        }
    }
}
