...
install:
  - ps: echo y | "%ANDROID_HOME%\tools\android.bat" update sdk -u -a -t tools
  - ps: echo y | "%ANDROID_HOME%\tools\android.bat" update sdk -u -a -t platform-tools
  - ps: echo y | "%ANDROID_HOME%\tools\android.bat" update sdk -u -a -t build-tools-25.0.1
  - ps: echo y | "%ANDROID_HOME%\tools\android.bat" update sdk -u -a -t android-24
